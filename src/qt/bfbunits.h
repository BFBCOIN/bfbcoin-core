...
#ifndef BFB_QT_BFBUNITS_H
#define BFB_QT_BFBUNITS_H
...
/** bfb unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class bfbUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit bfbUnits(QObject *parent);

    /** bfb units.
      @note Source: https://en.bfb.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BFB,
...
typedef bfbUnits::Unit bfbUnit;

#endif // BFB_QT_BFBUNITS_H
