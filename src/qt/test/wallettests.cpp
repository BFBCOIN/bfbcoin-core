...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<bfbAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_bfb-qt -platform xcb      # Linux
//     src/qt/test/test_bfb-qt -platform windows  # Windows
//     src/qt/test/test_bfb-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = bfbUnits::formatWithUnit(unit, balance, false, bfbUnits::separatorAlways);
    ...
    // Amount input
    bfbAmountField* amountInput = receiveCoinsDialog.findChild<bfbAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: bfb:")) != -1);
