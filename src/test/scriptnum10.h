...
#ifndef BFB_TEST_SCRIPTNUM10_H
#define BFB_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from bfb Core 0.10.0, for cross-comparison.
 */
public:
