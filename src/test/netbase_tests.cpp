...
{
    BOOST_CHECK(TestSplitHost("www.bfb.org", "www.bfb.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bfb.org]", "www.bfb.org", -1));
    BOOST_CHECK(TestSplitHost("www.bfb.org:80", "www.bfb.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bfb.org]:80", "www.bfb.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:3747", "127.0.0.1", 3747));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:3747", "127.0.0.1", 3747));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:3747", "::ffff:127.0.0.1", 3747));
    BOOST_CHECK(TestSplitHost("[::]:3747", "::", 3747));
    BOOST_CHECK(TestSplitHost("::3747", "::3747", -1));
    BOOST_CHECK(TestSplitHost(":3747", "", 3747));
    BOOST_CHECK(TestSplitHost("[]:3747", "", 3747));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:3747", "127.0.0.1:3747"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:3747", "[::]:3747"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
