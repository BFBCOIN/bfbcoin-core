...
#if defined(NDEBUG)
# error "bfb cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "bfb Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s BFB additional fees, %d delta bytes\n",
