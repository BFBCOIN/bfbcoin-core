...
class BIP66Test(bfbTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # bfbd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and bfbd produces more specific reject
            # reasons.
