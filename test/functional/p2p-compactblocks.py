...
# TestNode: A peer we use to send messages to bfbd, and store responses.
...
class CompactBlocksTest(bfbTestFramework):
    ...
    # This test actually causes bfbd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bfbd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bfbd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bfbd will not send blocktxn responses for blocks whose height is
