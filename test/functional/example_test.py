...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the bfbTestFramework
    pass

class ExampleTest(bfbTestFramework):
    # Each functional test is a subclass of the bfbTestFramework class.
    ...
    def custom_method(self):
        ...
        bfbTestFramework class so other tests can use it."""
