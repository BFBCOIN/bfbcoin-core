...
By default, bfbd will dump mempool on shutdown and
...
class MempoolPersistTest(bfbTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give bfbd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent bfbd from writing mempool.dat to disk. Verify that `savemempool` fails")
