...
class TxnMallTest(bfbTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 BFB:
        ...
        # First: use raw transaction API to send 1240 BFB to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 BFB coin each
        ...
        # Node0's balance should be starting balance, plus 50BFB for another
        ...
        # Node0's total balance should be starting balance, plus 100BFB for 
