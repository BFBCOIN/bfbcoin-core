...
This document provides guidelines for internationalization of the bfb Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bfb_en.ts` remains unchanged.
